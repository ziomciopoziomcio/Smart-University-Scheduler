            ...
            <DialogContent sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
                ...
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1, mt: 1 }}>
                    <Button
                        ...
                        sx={{ bgcolor: '#2b5073', borderRadius: '12px', py: 1.5, textTransform: 'none', fontSize: '1rem' }}
                    >
                        {loading ? <CircularProgress size={24} color="inherit" /> : intl.formatMessage({ id: 'facilities.common.save' })}
                    </Button>
                    <Button
                        variant="text"
                        onClick={onClose}
