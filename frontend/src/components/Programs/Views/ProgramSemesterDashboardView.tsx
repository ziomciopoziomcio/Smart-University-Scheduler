...
export function ProgramSemesterDashboardView({ facultyId, fieldId, programId, semesterId }: ProgramSemesterDashboardProps) {
    ...
    const options = [
        {
            ...
            description: intl.formatMessage({ id: 'programs.dashboard.curriculumDesc', defaultMessage: 'Zarządzaj przedmiotami w tym semestrze' }),
            icon: MenuBookIcon,
        ...
        },
        {
            ...
            description: intl.formatMessage({ id: 'programs.dashboard.groupsDesc', defaultMessage: 'Zarządzaj grupami i przypisuj studentów' }),
            icon: GroupsIcon,
